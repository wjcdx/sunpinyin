static const char *initials[] = { "", "b", "p", "m", "f", "d", "t", "n", "l", "g", "k", "h", "j", "q", "x", "zh", "ch", "sh", "r", "z", "c", "s", "y", "w", "hm" };
static const unsigned num_initials = sizeof(initials) / sizeof(*initials);

static const char *finals[] = { "", "a", "o", "e", "ai", "ei", "ao", "ou", "an", "en", "ang", "eng", "er", "i", "ia", "ie", "iao", "iu", "ian", "in", "iang", "ing", "u", "ua", "uo", "uai", "ui", "uan", "un", "uang", "ong", "v", "ve", "ue", "iong", "ng" };
static const unsigned num_finals = sizeof(finals) / sizeof(*finals);

static const char *fuzzy_finals[] = { "ia", "iao", "ian", "iang", "ie", "ua", "uai", "uan", "uang", "ue", "ve" };
...
static const TPyTabEntry pinyin_table[] = {
    { "a",      0x00010 },
    { "ai",     0x00040 },
    { "an",     0x00080 },
    { "ang",    0x000a0 },
