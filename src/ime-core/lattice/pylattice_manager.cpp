...
void
CPYLatticeManager::_forwardSyllables(unsigned i,
                               unsigned j,
...
void
CPYLatticeManager::_forwardString(unsigned i,
                            unsigned j,
...
void
CPYLatticeManager::_forwardSingleSyllable(unsigned i,
                                    unsigned j,
                                    TSyllable syllable,
                                    const IPySegmentor::TSegment& seg,
                                    bool fuzzy)
...
void
CPYLatticeManager::_forwardSyllableSep(unsigned i, unsigned j)
{
    CLatticeFrame &fr = this.getLatticeFrame(j);
...
void
CPYLatticeManager::_forwardPunctChar(unsigned i, unsigned j, unsigned ch)
{
    CLatticeFrame &fr = this.getLatticeFrame(j);
...
void
CPYLatticeManager::_forwardOrdinaryChar(unsigned i, unsigned j, unsigned ch)
{
    CLatticeFrame &fr = this.getLatticeFrame(j);
...
void
CPYLatticeManager::_forwardTail(unsigned i, unsigned j)
{
    CLatticeFrame &fr = this.getLatticeFrame(j);
